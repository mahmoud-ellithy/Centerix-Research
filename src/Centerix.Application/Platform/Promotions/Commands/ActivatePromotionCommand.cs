...
public record ActivatePromotionCommand(int Id) : IRequest<Result<Updated>>;

public class ActivatePromotionHandler(
    IAppDbContext dbContext,
    IPlatformAdminGuard platformAdminGuard,
    IAuditWriter auditWriter) : IRequestHandler<ActivatePromotionCommand, Result<Updated>>
{
    public async Task<Result<Updated>> Handle(ActivatePromotionCommand request, CancellationToken cancellationToken)
    {
